 ...
 * Generated at: 2018-06-08 03:40:43 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<span class=\"login_cont\">注册</span>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<!--请用户输入手机号码-->\r\n");
      out.write("\t<div class=\"pass_layout\">\r\n");
      out.write("\t\t<form action=\"javascript:void(0);\" method=\"post\">\r\n");
      out.write("\t\t\t<div class=\"input_style\">\r\n");
      out.write("\t\t\t\t<!-- onchange=\"RegUserInput();\" -->\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"phone_mess\" id=\"phone_mess\"\r\n");
      out.write("\t\t\t\t\tplaceholder=\"请输入手机号码\" maxlength=\"11\" />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"input_style pwd_input\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" id='pwdOnce' placeholder=\"密码长度为6-16位大小字母，符号或数字\"\r\n");
      out.write("\t\t\t\t\tmaxlength=\"20\" />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"input_style pwd_input\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" id='pwdTwo' placeholder=\"再次输入密码\" maxlength=\"20\" />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"message_div\">\r\n");
      out.write("\t\t<div style='overflow: hidden; display: none;' class=\"getMessage_show\">\r\n");
      out.write("\t\t\t<div class=\"sj_notinput\">\r\n");
      out.write("\t\t\t\t<img src=\"/resources/img/tishi.png\" />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<span id=\"warningText\">asdsa</span>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<!--注册-->\r\n");
      out.write("\t<div class=\"nextPass\" onclick=\"register()\">注册</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      ...
      out.write("\t\tphone = $('#phone_mess').val();\r\n");
      out.write("\t\tpwdO = $('#pwdOnce').val();\r\n");
      out.write("\t\tpwdT = $('#pwdTwo').val();\r\n");
      out.write("\t\tvar reg = /^1[0-9]{10,}$/;\r\n");
      out.write("\t\tif (!phone || '' === phone || !reg.test(phone)) {\r\n");
      out.write("\t\t\t$.message.alert('info', '提示信息', '请输入正确的手机号！');\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif (pwdO === '' || pwdO.length > 16 || pwdO.length <5) {\r\n");
      out.write("\t\t\t$.message.alert('info', '提示信息', '请输入正确的密码！');\r\n");
      out.write("\t\t\t$('#pwdOnce').val();\r\n");
      out.write("\t\t\t$('#pwdTwo').val();\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif (pwdT != pwdO) {\r\n");
      out.write("\t\t\t$('#pwdOnce').val();\r\n");
      out.write("\t\t\t$('#pwdTwo').val();\r\n");
      out.write("\t\t\t$.message.alert('info', '提示信息', '两次密码输入不一致');\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl : \"/login/register.do\",\r\n");
      out.write("\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\tdata : {\r\n");
      out.write("\t\t\t\tphone : phone,\r\n");
      out.write("\t\t\t\tpassword : pwdO\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\tob = eval('(' + data + ')');\r\n");
      out.write("\t\t\t\tif (ob.result == 'success') {\r\n");
      ...
      out.write("\t\t\t\t\tlocation.href = \"/index.do\";\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$.message.alert(\"info\", \"提示\", \"手机号未注册或密码错误！\");\r\n");
      out.write("\t\t\t\t\t$('#pwdOnce').val();\r\n");
      out.write("\t\t\t\t\t$('#pwdTwo').val();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
